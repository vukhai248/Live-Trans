import type { ApiKeyWarningBannerProps } from './SettingsModal/types';
...
export function ApiKeyWarningBanner({
  ...
  return (
    <div class="lt-api-key-warning-banner">
      <div class="lt-warning-left">
        ...
        <div>
          <div class="lt-warning-title">
            Cảnh báo: Chưa cấu hình {provider === 'zen' ? 'OpenCode Zen' : 'Google Gemini'} API Key
          </div>
      ...
      <button class="lt-btn lt-btn-warning" onClick={onOpenSettings}>
